...
export default function (app) {
    return __awaiter(this, void 0, void 0, function* () {
        const { IsSnowflake, ValidateSnowflake } = yield import('../helpers/validators.js');
        const ResDef = yield (yield import("../helpers/response.js")).default;
        const { fetchUser } = yield import("../helpers/user.js");
        const { fetchImg } = yield import("../helpers/image.js");
